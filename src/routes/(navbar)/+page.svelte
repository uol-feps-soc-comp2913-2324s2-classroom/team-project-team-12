...
<body class="bg-white dark:bg-gray-900">
    <div class="container">
        ...
        <div class="subheading">
            <P color="text-gray-500 dark:text-gray-400">Welcome to the ultimate route tracking experience.</P>
        </div>
        ...
        <div class="feature-container">
            ...
            <div class="feature">
                ...
                <P color="text-gray-500 dark:text-gray-400"
                    >Connect with friends and share your fitness journey with them.</P
                >
            </div>
        </div>
        <Hr classHr="my-8" />
            ...
            <Card padding="xl">
                ...
                <ul class="my-7 space-y-4">
                    ...
                    <li class="flex space-x-2 rtl:space-x-reverse">
                        <CheckCircleSolid class="w-4 h-4 text-primary-600 dark:text-primary-500" />
                        <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400"
                            >One yearly payment.</span
                        >
                    </li>
                    <li class="flex space-x-2 rtl:space-x-reverse">
                        <CheckCircleSolid class="w-4 h-4 text-primary-600 dark:text-primary-500" />
                        <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400"
                            >Save over <b>£50!</b></span
                        >
                    </li>
                </ul>
        ...
        <div class="heading">
            <Heading tag="h1" class="mb-4" customSize="text-4xl font-extrabold  md:text-5xl lg:text-6xl"
                >Access journeys on the go!</Heading
            >
        </div>
        <div class="subheading">
            <P color="text-gray-500 dark:text-gray-400">Available in the App Store and Google Play.</P>
        </div>
        ...
        <div class="mobile">
            ...
            <div class="text-container">
                <P color="text-gray-500 dark:text-gray-400"
                    >Plan your routes on the fly with our route plotting app, now available on
                    <strong class="font-semibold text-gray-900 dark:text-white"> iOS and Android. </strong>
                    Whether you're on your desktop or on the move, our app ensures that your routes are always accessible,
                    wherever your travels take you. Download now and start exploring!</P
                >
            </div>
        </div>
